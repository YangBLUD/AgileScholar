<template>
    ...
    <div style="position: relative; padding-top: 65px;">
        <div class="main">
            <div class="second">
                ...
                <div class="middle-right">
                    ...
                    <div class="middle-right-sum">
                        ...
                        <div class="sum-text">
                            ...
                            <div class="text-second">Expand to The ACM Guide to Computing Literature (3,605,660 records)
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="drop-choice">
                            <el-col :span="8">
                                <el-dropdown trigger="click">
                                    ...
                                    <template #dropdown>
                                        <el-dropdown-menu>
                                            <el-dropdown-item :key=index v-for="(item, index) in sortlist"
                                                @click="changesort(item)">{{ item.text }}</el-dropdown-item>
                                        </el-dropdown-menu>
                                    </template>
                                </el-dropdown>
                            </el-col>
                    ...
                    <div class="middle-right-list">
                        ...
                        <div class="bottom-page">
                            <div class="example-pagination-block">
                                <el-pagination layout="prev, pager, next" :page-count="totalye"
                                    v-model:current-page="currentPage" @current-change="currentChange"
